<?php namespace App\Http\Controllers;
	...
	class AdminStudentsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:students","placeholder"=>"Please enter a valid email address"];
